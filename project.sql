...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2022 at 11:44 AM
...
(6, 15, 6, NULL, 'Nice moustache', 0),
(7, 15, 3, 0, 'A new product was suggested <a href=\"DisplaySuggestions.php\">Click Here</a> to view', 0),
(8, 15, 4, 0, 'A new product was suggested <a href=\"DisplaySuggestions.php\">Click Here</a> to view', 0),
(9, 15, 5, 0, 'A new product was suggested <a href=\"DisplaySuggestions.php\">Click Here</a> to view', 0),
(10, 15, 6, 0, 'A new product was suggested <a href=\"DisplaySuggestions.php\">Click Here</a> to view', 0),
(11, 6, 15, NULL, 'We will do our best to have this product available, we will notify you when it is purchasable', 0);
...
(2, 15, 'resources/images/SuggestedProducts/harddisk.jpg', '', 'WD blue 1TB hard disk', 'A useful hard disk');
...
--
ALTER TABLE `message`
  MODIFY `messageID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
