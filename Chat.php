<html>
    <head>
        ...
        if($_SESSION['userType']=="auditor")
        {
            ...
            ?>
                            <a href=Chat.php?auditor_for_admin_id=<?php echo $unique_admin_IDS[$i] ?>> YOU WANNA SEE MY CHATS MF? </a>
                            <br>
        <?php                            
                            }
             
        $sql="SELECT * FROM message, users WHERE ( (senderID='".$_GET['auditor_for_admin_id']."') OR ( recepientID='".$_GET['auditor_for_admin_id']."') ) AND SenderID=users.id";
        ...
        while($row =$result->fetch_assoc())
        {
                ...
                if($row['id'] != $_GET['auditor_for_admin_id'])
                {
                    ...
                    for($i=0;$i<sizeof($id_arr);$i++)
                    {
                        ...
                        if($repeated==false){
                            ...
                            <a href="Chat.php?auditor_for_admin_id=<?php echo $row['id']?>">
